...
for dir in "$BASE_DIR"/*/; do
  ...
  sh /root/workspace/precise_style_change/detect_style_change.sh $project $version $tool $use_Rewrite
  sh /root/workspace/precise_style_change/combine_style_change_results.sh $project $version $tool $use_Rewrite
