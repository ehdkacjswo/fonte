...
def parse_diff(diff_txt, diff_commit, src_path):
    ...
    for line in diff_lines:
        ...
        if line_match:
            ...
            old_line_num = 1 if line_match.group(2) is None else int(line_match.group(2))
            cur_new_line = int(line_match.group(3))
            new_line_num = 1 if line_match.group(4) is None else int(line_match.group(4))
            continue
